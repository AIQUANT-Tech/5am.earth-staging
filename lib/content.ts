...
export function defaultContent(): SiteContent {
  const content: SiteContent = {
    ...
    sections: [
      ...
      sec("home-network", "home", "Network today + pilot", 1, {
        ...
        intro:
          "The Syngenta Foundation Agri-Entrepreneur program already connects local entrepreneurs with farmers across India. 5am.earth is building the verification layer on that working network.",
        stat1n: "2.4M+",
        stat1l: "smallholder farmers connected through the program",
        stat2n: "21K+",
        stat2l: "trained Agri-Entrepreneurs in the established network",
        stat3n: "45%",
        stat3l: "of connected farmers are women",
        stat4n: "52%",
        stat4l: "of Agri-Entrepreneurs were women in 2024",
        sourceNote:
          "Source: Earth Observation and Blockchain Integration research report. Network figures refer to the Syngenta Foundation Agri-Entrepreneur program in India.",
        pilotEyebrow: "Planned initial deployment",
        pilotH3: "The next step is measured, not assumed.",
        pilot1n: "1,000",
        pilot1l: "Agri-Entrepreneurs",
        pilot2n: "100,000",
        pilot2l: "farmers",
        pilot3n: "2",
        pilot3l: "initial oracle use cases",
      }),
      sec(
        "home-verify",
        "home",
        "How a record earns trust",
        2,
        {
      ...
      sec("home-users", "home", "Audiences intro", 3, {
        ...
        intro:
          "One verified record can answer different questions. Choose the decision you need to make.",
      }),
      ...
      sec(
        ...
        5,
        {
          ...
          m1t: "Use case 01",
          m1b: "Land border verification",
          m2t: "Use case 02",
          m2b: "Historical sustainability rating",
          m3t: "Goal",
          m3b: "Lower risk and expand financial inclusion",
      ...
      sec(
        "process-stages",
        "process",
        "Four stage cards + infographic",
        1,
        {
          s1t: "Capture",
          s1b: "An Agri-Entrepreneur records the farmer, field and activity where the work happens.",
          s2t: "Validate",
          s2b: "Satellite imagery verifies field boundaries against current signals and land history.",
          s3t: "Authenticate",
          s3b: "Identity and consent are attached to the evidence. Its source can now be traced.",
          s4t: "Reuse",
          s4b: "The farmer can permit the same record to support another service or decision.",
        },
      ...
      sec(
        ...
        1,
        {
          ...
          intro:
            "The Syngenta Foundation Agri-Entrepreneur program supplies the relationships on the ground. The first 5am.earth deployment is planned on top of that network.",
          stat1n: "2.4M+",
          stat1l: "smallholder farmers connected across India",
          stat2n: "21K+",
          stat2l: "trained Agri-Entrepreneurs",
          stat3n: "13",
          stat3l: "Indian states reached by the program",
          stat4n: "100K",
          stat4l: "farmers planned for the initial deployment",
          sourceNote:
            "Evidence: Syngenta Foundation India program information and the Earth Observation and Blockchain Integration research report. Deployment figures describe the initial planned implementation.",
          photo1cap: "Human field evidence",
          photo1body:
            "Local training and trusted Agri-Entrepreneur relationships ground every record.",
          photo2cap: "Earth observation evidence",
          photo2body:
            "Satellite imagery helps validate field boundaries and historical land signals.",
        },
        "/collage/use-case-farmer.png",
        "/collage/network-satellite.png",
      ),
      sec("usecases-apps", "use-cases", "Applications grid intro", 2, {
        eyebrow: "Applications",
        h2: "Six decisions. One source of evidence.",
        intro:
          "The record stays consistent. What changes is the question each organization asks of it.",
      }),
      sec("usecases-implementation", "use-cases", "Initial implementation", 3, {
        ...
        m1t: "Land",
        m1b: "Verified field boundaries",
        m2t: "History",
        m2b: "Sustainability evidence",
        m3t: "Services",
        m3b: "Finance, insurance, advisory, and markets",
      }),
      ...
      sec(
        ...
        1,
        {},
        "/collage/partners-pair.png",
      ),
      sec("partners-value", "partners", "Value for every participant", 2, {
        eyebrow: "Value for every participant",
        h2: "Why join the ecosystem?",
        intro:
          "Partnership is not a logo wall. It is a practical exchange of reach, evidence, infrastructure, capability, and opportunity.",
      }),
      ...
      sec("team-structure", "team", "Team structure intro", 1, {
        ...
        intro:
          "Replace these role groups with approved team names, titles, portraits, and biographies before launch.",
      }),
      ...
      sec("casestudies-story", "case-studies", "Story + stats + quote", 1, {
        ...
        h2: "Satellite Oracle for smallholder agriculture.",
        intro:
          "A collaboration designed around the Syngenta Foundation Agri-Entrepreneur program and its existing farmer relationships.",
        stat1n: "2.4M+",
        stat1l: "farmers in the established network",
        stat2n: "21K+",
        stat2l: "trained Agri-Entrepreneurs",
        stat3n: "100K",
        stat3l: "farmers in the planned initial deployment",
        s1t: "The challenge",
        s1b: "Farmer and field evidence is repeatedly collected, difficult to reuse, and often disconnected from financial and market services.",
        s2t: "The system",
        s2b: "Agri-Entrepreneurs capture field data. Satellite data validates boundaries and land signals. Cardano infrastructure records verifiable provenance.",
        s3t: "The first use cases",
        s3b: "Blockchain-verified land border records and historical sustainability ratings create reusable evidence for services and decisions.",
        s4t: "The intended value",
        s4b: "Lower risk for financial partners, better service delivery, and new pathways to finance, insurance, markets, and advisory support.",
        quote:
          "Verified once. Reused across the next service, decision, and opportunity.",
      }),
    ...
    useCases: [
      {
        ...
        body: "Verify a field boundary and its history before pricing risk or extending a service.",
      },
      {
        id: "uc2",
        order: 1,
        title: "Markets and procurement",
        body: "Trace a sourcing claim back to the farmer and field evidence behind it.",
      },
      {
        id: "uc3",
        order: 2,
        title: "Farmer services",
        body: "Use field history and crop signals to decide what support is needed now.",
      },
      {
        id: "uc4",
        order: 3,
        title: "Sustainability",
        body: "Compare current claims with historical satellite evidence and recorded fieldwork.",
      },
      {
        id: "uc5",
        order: 4,
        title: "Programs and policy",
        body: "See who a program reaches and measure change against consistent records.",
      },
      {
        id: "uc6",
        order: 5,
        title: "Products and research",
        body: "Build a product on permissioned records without collecting the same evidence again.",
      },
    ],
    team: [
      {
        id: "tm1",
        order: 0,
        name: "Foundation leadership",
        role: "Stewardship & governance",
        bio: "Stewardship, governance, partnerships, and long-term mission.",
        photo: "",
      },
      {
        id: "tm2",
        order: 1,
        name: "Product and data",
        role: "Product & data",
        bio: "Farmer-centered products, interoperable data models, and decision-ready intelligence.",
        photo: "",
      },
      {
        id: "tm3",
        order: 2,
        name: "Field and program",
        role: "Field & program",
        bio: "Agri-Entrepreneur enablement, farmer relationships, training, and local delivery.",
        photo: "",
      },
      {
        id: "tm4",
        order: 3,
        name: "Technology and verification",
        role: "Technology & verification",
        bio: "Earth observation, secure provenance, identity, and platform infrastructure.",
        photo: "",
      },
    ],
    partners: [
      {
        id: "pt1",
        order: 0,
        name: "Syngenta Foundation India",
        logo: "https://aegf.in/wp-content/uploads/2025/03/SFI_SFI.png",
        visible: true,
      },
      {
        id: "pt2",
      ...
      },
      {
        ...
        order: 2,
        name: "Andamio",
        logo: "https://www.andamio.io/andamio-logo-w-typography.jpg",
        visible: true,
      },
    ],
    audiences: [
      {
        ...
        body: "Assess a field using evidence that can be verified at its source, then reused at the next decision.",
        cta: "Explore finance use cases",
      },
      {
        id: "au2",
        order: 1,
        visible: true,
        title: "Buyers and supply chains",
        body: "See where produce came from and which farmer and field records support the claim.",
        cta: "Explore market use cases",
      },
      {
        id: "au3",
        order: 2,
        ...
        body: "Track who a program reaches and what changes in the field without rebuilding the record each time.",
        cta: "Explore program use cases",
      },
      {
        id: "au4",
        order: 3,
        ...
        body: "Build products and models on agricultural records shared with permission.",
        cta: "Build with 5am.earth",
      },
      {
        id: "au5",
        order: 4,
        ...
        body: "Turn fieldwork into a verified contribution that strengthens the next service you provide.",
        cta: "Join the field network",
      },
      {
        id: "au6",
        order: 5,
        visible: true,
        title: "Farmers",
        body: "Keep one portable farmer and field record for the services you choose to access.",
        cta: "See the farmer benefit",
      },
    ],
    settings: {
      headerBg: "#EAE2D7",
  ...
  for (const s of content.sections) {
    if (!s.image) continue;
    s.image.position =
      s.id === "home-case" || s.id === "home-partners" ? "left" : "right";
  }
...
export function getContent(): SiteContent {
  try {
    ...
    const partnersSection = parsed.sections?.find(
      (s) => s.id === "home-partners",
    );
    ...
    if (parsed.settings.contactEmailLabel === undefined) {
      parsed.settings.contactEmailLabel =
        defaultContent().settings.contactEmailLabel;
      needsSave = true;
    }
    if (partnersSection && partnersSection.content.bullets === undefined) {
      ...
      const lines = legacyIntro
        ...
        .map((s) => s.trim())
        .filter(Boolean);
      partnersSection.content.bullets =
        lines.length > 0
          ? lines.join("\n")
          : defaultContent().sections.find((s) => s.id === "home-partners")!
              .content.bullets;
      delete partnersSection.content.intro;
      needsSave = true;
    }
    if (partnersSection && !partnersSection.image) {
      partnersSection.image = {
        src: "/collage/case-study-map.png",
        scale: 100,
      };
      needsSave = true;
    }
...
/**
 * The @font-face rule, emitted as an inline <style> rather than living in
 * globals.css.
 *
 * Next copies `url()` values out of a stylesheet verbatim - it does not apply
 * basePath to them - so a hardcoded path in the CSS would be wrong in
 * whichever environment it was not written for. Building the URL through
 * asset() makes it follow NEXT_PUBLIC_BASE_PATH like everything else.
 *
 * Letting webpack resolve the font instead (url("../public/fonts/...")) would
 * also work, but it hashes the file into _next/static/media/, and the
 * <link rel="preload"> in app/layout.tsx would no longer point at the same
 * URL - which is what causes the font to be downloaded twice.
 */
export function fontFaceCss(): string {
  return `
    @font-face {
      font-family: "Manrope";
      src:
        url("${asset("/fonts/Manrope-VariableFont_wght.woff2")}") format("woff2-variations"),
        url("${asset("/fonts/Manrope-VariableFont_wght.ttf")}") format("truetype-variations");
      font-weight: 200 800;
      font-style: normal;
      font-display: swap;
    }
